<template>
	<view class="searchLayout">
		...
		<view class="noSearch" v-if="noSearch">
			<uv-empty mode="search" icon="/static/images/null.svg"></uv-empty>
		</view>
		...
		<view v-else>
			...
			<view class="loadingBox" v-if="noData || classList.length"><uni-load-more
